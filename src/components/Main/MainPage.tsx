  ...
  return (
    <>
      ...
      <><div className={styles.myinformation}>
        ...
        </div><div id="about"></div><div className={styles.who}>
          ...
          </div><div className='mt-5'></div><div id="tech"></div><div className={styles.techbox}>
            <div className='mt-5'></div>
          ...
          </div><div className='mt-5'></div><div id="project"></div><div className={styles.projectimgbox}>
            <div className='mt-5'></div>
            <p>Projects</p>
          ...
          </div><div className='mt-5'></div><div id="award"></div><div className={styles.awardbox}>
            <div className='mt-5'></div>
